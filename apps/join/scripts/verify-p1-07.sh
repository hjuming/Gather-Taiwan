#!/usr/bin/env bash
# Runs the P1-07 invite/password behavior verification against the Gather
...
PGCONNECT_TIMEOUT=15 PGPASSWORD="$SUPABASE_DB_PASSWORD" psql "$DB_URL" -f scripts/verify-p1-07-rls.sql
